...
class SignUpEmailInput extends ValidatedEmailInput<IBaseInputProps> {
  @autobind
  public async handleChange(email: string) {
    ...
    dispatch(new SetSignUpEmailFieldAction({ value: email, isValid: false, error: null }))
...
export default connect(mapStateToProps)(SignUpEmailInput)
